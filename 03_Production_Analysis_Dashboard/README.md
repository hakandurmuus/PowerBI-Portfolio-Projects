...
- **DAX & KPI:** Critical production metrics such as Scrap Rate (%) and Shipment Time calculated using `DIVIDE` and `AVERAGE`.  
- **Trend Analysis:** Periodic changes in production quantities (Year/Quarter/Month) visualized with line charts.  
- **Gauge Charts:** Used to track Target vs Actual performance.

![Production Dashboard](screenshot.png)
